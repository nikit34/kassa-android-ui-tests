...
class TestMoviePage:
    ...
    def test_tab_movie_is_selected_when_app_opened(self, driver):
        ...
        tab_trend = self.movie_page.find_element(*self.common_locators.tab_trend)
        assert tab_trend.is_selected(), f'invalid state: {tab_trend}'
        tab_search = self.movie_page.find_element(*self.common_locators.tab_search)
        assert not tab_search.is_selected(), f'invalid state: {tab_search}'
        tab_ticket = self.movie_page.find_element(*self.common_locators.tab_ticket)
        assert not tab_ticket.is_selected(), f'invalid state: {tab_ticket}'
        tab_places = self.movie_page.find_element(*self.common_locators.tab_places)
        assert not tab_places.is_selected(), f'invalid state: {tab_places}'
        tab_profile = self.movie_page.find_element(*self.common_locators.tab_profile)
    ...
    def test_check_feature_content(self, driver):
        ...
        movie_base_canvas = self.movie_page.find_element(*self.movies_locators.carousel_rv)
        movie_base_canvas_row = self.movie_page.find_element(*self.movies_locators.list_session_view)
    ...
    def test_hiding_eventstabs_after_swipe_down(self, driver):
        ...
        sleep(1)
        self.movie_page.not_displayed(*self.movies_locators.feature_app_bar)
        self.movie_page.not_displayed(*self.movies_locators.tabs_rv)

    def test_top_movies_are_visible(self, driver):
        self.movie_page = MoviesPage(driver)
        self.movie_page.set_custom_wait(15)
        self.movie_page.find_element(*self.movies_locators.event_img)

    def test_top_movie_is_opened_from_featurer(self, driver):
        self.movie_page = MoviesPage(driver)
        self.movie_page.set_custom_wait(15)
        self.movie_page.click_random(*self.movies_locators.event_img, 3)
    ...
    def test_hide_and_show_up_headers_tabs(self, driver):
        ...
        sleep(1)
        self.movie_page.find_element(*self.movies_locators.feature_app_bar)
        self.movie_page.find_element(*self.movies_locators.tabs_rv)
    ...
    def test_popular_movies_are_visible(self, driver):
        ...
        sleep(1)
        self.movie_page.find_element(*self.movies_locators.compilation_img)
        self.movie_page.find_element(*self.movies_locators.favorite_container)
    ...
    def test_premiers_are_available(self, driver):
        ...
        sleep(1)
        self.movie_page.matching_text(*self.movies_locators.movies_title, pattern='Скоро в кино')
        self.movie_page.find_element(*self.movies_locators.carousel_rv)
    ...
    def test_flop_into_popular_movie(self, driver):
        ...
        self.movie_page.act.swipe(50, 60, 50, 40)
        sleep(1)
        self.movie_page.click(*self.movies_locators.compilation_img)
        self.movie_page.pass_allow_photo_media()
        self.movie_page.find_element(*self.events_details_locators.event_trailer)
    ...
    def test_popular_movies_are_visible(self, driver):
        ...
        self.movie_page.act.swipe(50, 80, 50, 20)
        sleep(1)
        self.movie_page.click(*self.movies_locators.event_title)
        self.movie_page.find_element(*self.events_details_locators.event_trailer)
    ...
    def test_popular_movies_are_visible_(self, driver):
        ...
        self.movie_page.act.swipe(50, 60, 50, 40)
        sleep(1)
        self.movie_page.click(*self.movies_locators.arrow_right)
        self.movie_page.find_element(*self.shedule_locators.event_name)
    ...
    def test_popular_movies_are_visible__(self, driver):
        ...
        sleep(1)
        self.movie_page.click(*self.movies_locators.event_title)
        self.movie_page.find_element(*self.events_details_locators.description)
    ...
    def test_premiers_are_available(self, driver):
        ...
        sleep(1)
        self.movie_page.matching_text(*self.movies_locators.movies_title, pattern='Скоро в кино')
        self.movie_page.click(*self.movies_locators.movies_title)
    ...
    def test_close_premier_schedule_sheet_from_carousel_(self, driver):
        self.movie_page = MoviesPage(driver)
        self.movie_page.set_custom_wait(15)
        self.movie_page.click(*self.movies_locators.event_img)
        self.event_detail_page = EventsDetailsPage(driver)
        self.event_detail_page.set_custom_wait(15)
        ...
        self.movie_page.find_element(*self.movies_locators.list_session_view)
